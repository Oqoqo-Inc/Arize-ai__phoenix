...
> For end-to-end examples of reconstructing and managing sessions from your application code, see the Sessions how-to: `/docs/phoenix/tracing/how-to-tracing/setup-tracing/setup-sessions#programmatically-querying-sessions`.
