...
<Info>
For end-to-end guidance on when and how to use these APIs, see the main [Sessions](/docs/phoenix/tracing/llm-traces/sessions) documentation and the Python and TypeScript SDK reference pages.
</Info>
