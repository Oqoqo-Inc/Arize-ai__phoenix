...
<Note>
For up-to-date guides and SDK examples, see the [Sessions concept page](/docs/phoenix/tracing/llm-traces/sessions), the [Setup Sessions how-to](/docs/phoenix/tracing/how-to-tracing/setup-tracing/setup-sessions), and the Python and TypeScript SDK reference pages.
</Note>
...
<Note>
For end-to-end session management workflows, including listing, deleting, and annotating sessions via the SDKs, see the main Sessions documentation and SDK reference pages.
</Note>
