...
For end-to-end examples of using these APIs to rebuild transcripts and manage sessions, see the [Sessions tutorial](/docs/phoenix/tracing/tutorial/sessions#programmatic-session-apis).
