...
Once sessions are flowing into Phoenix, you can also work with them programmatically. The Phoenix SDKs and REST API let you:

- List sessions for a project
- Reconstruct the turns in a conversation
- Delete individual or multiple sessions for cleanup
- Attach annotations at the session level

To learn how to use these APIs, see [Manage sessions programmatically](/docs/phoenix/tracing/how-to-tracing/manage-sessions) and the [Sessions REST API reference](/docs/phoenix/sdk-api-reference/rest-api/api-reference/sessions).
