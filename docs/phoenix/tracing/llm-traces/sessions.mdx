...
<CardGroup cols={2}>
  ...
  <Card title="Query & Manage Sessions" icon="list" href="/docs/phoenix/tracing/how-to-tracing/setup-tracing/setup-sessions#query-reconstruct-and-clean-up-sessions">
    Reconstruct transcripts, query, and clean up sessions programmatically
  </Card>
