...
<CardGroup cols={3}>
  ...
  <Card title="Manage Sessions Programmatically" icon="terminal" href="/docs/phoenix/tracing/how-to-tracing/manage-sessions">
    Retrieve, clean up, and annotate sessions via SDKs
  </Card>
</CardGroup>
