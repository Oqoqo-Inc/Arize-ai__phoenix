...
<CardGroup cols={2}>
  ...
  <Card title="Programmatic Session APIs" icon="terminal" href="/docs/phoenix/tracing/tutorial/sessions#programmatic-session-apis">
    Reconstruct, clean up, and annotate sessions via API
  </Card>
</CardGroup>
