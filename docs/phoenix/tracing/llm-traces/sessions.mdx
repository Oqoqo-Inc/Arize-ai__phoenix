...
Beyond the Phoenix UI, Sessions are also available through the client SDKs. You can:

* Reconstruct a conversation as an ordered list of turns using the Session Turns API

* List, export, and delete sessions (including cascading cleanup of associated traces and spans)
...
<CardGroup cols={2}>
  <Card title="Setup Sessions" icon="gear" href="/docs/phoenix/tracing/how-to-tracing/setup-tracing/setup-sessions">
    Configure session tracking and programmatic access in your application
  </Card>
