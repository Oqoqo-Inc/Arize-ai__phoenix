...
### Get Session Turns (experimental)
...
<Note>
Session deletion and bulk deletion require arize-phoenix server 13.13.0+ and compatible client versions. `getSessionTurns` and `logSessionAnnotations` are available in @arizeai/phoenix-client 6.4.0+.
