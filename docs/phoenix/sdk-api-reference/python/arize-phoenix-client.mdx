...
Retrieve and manage session data for multi-turn conversations. Sessions group related traces from a conversation into a single timeline.
...
Reconstruct the ordered turns in a conversation from all traces in a session:
...
Attach annotations to entire sessions for evaluation and review workflows:
