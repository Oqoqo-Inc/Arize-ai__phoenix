...
<Tip>
**Want the simplest possible eval first?** Before the full rubric below, try a minimal evaluator:

The goal of this guide is not to design a perfect rubric. It is to attach one repeatable quality signal to existing traces.

- **Traces** tell you what happened.
- **Evaluations** tell you whether that output passed your check.

### Minimal Starter Evaluator
...
After you see this working in Phoenix, expand it into a domain-specific rubric like the financial example below.
